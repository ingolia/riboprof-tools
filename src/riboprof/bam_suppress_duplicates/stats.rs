...
impl Stats {
    ...
    pub fn untagged_reads(&self) -> u64 { self.untagged_count }
    pub fn total_reads(&self) -> u64 { self.total_reads_count }
    pub fn unique_reads(&self) -> u64 { self.unique_reads_count }
    pub fn dupl_reads(&self) -> u64 { self.total_reads_count - self.unique_reads_count }
    pub fn total_sites(&self) -> u64 { self.total_sites_count }
    pub fn dupl_sites(&self) -> u64 { self.dupl_sites_count }                                       
